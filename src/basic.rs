...
#[allow(unused)]
pub fn drill_1_print_schemea(df: &DataFrame) {
    println!("{:?}", df.schema());
...
#[allow(unused)]
pub fn drill_2_mean_trip_distance(df: &DataFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_3_avg_tip_per_payment_type(df: DataFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_4_avg_trip_distance_and_total_revenue_per_hour(
    df: DataFrame,
...
#[allow(unused)]
pub fn drill_5_trip_distance_greater_than(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_6_passenter_count_gt_3(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_7_trips_where_type_is_card_and_tip_is_gt_0(
    lf: LazyFrame,
) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_8_new_trip_percentage(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_9(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
    /*
...
#[allow(unused)]
pub fn drill_10(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
    /*
...
#[allow(unused)]
pub fn drill_11(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_12(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_13(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
...
#[allow(unused)]
pub fn drill_14(lf: LazyFrame) -> Result<(), Box<dyn std::error::Error>> {
